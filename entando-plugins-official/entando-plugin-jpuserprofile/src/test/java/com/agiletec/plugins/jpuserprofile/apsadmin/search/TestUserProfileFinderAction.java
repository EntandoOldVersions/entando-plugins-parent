...
import com.agiletec.plugins.jpuserprofile.apsadmin.search.IUserProfileFinderAction;
import com.agiletec.plugins.jpuserprofile.apsadmin.search.UserProfileFinderAction;
...
public class TestUserProfileFinderAction extends ApsAdminPluginBaseTestCase {
	...
	public void testSearchSuperUser() throws Throwable{
		try{
			...
			this.initAction("/do/jpuserprofile/Search", "list");
	...
	public void testInsertUsername() throws Throwable {
		try {
			this.setUserOnSession("admin");
			this.initAction("/do/jpuserprofile/Search", "search");
