...
<div id="main">
	<h2><s:text name="jpuserprofile.title.changeUserProfile" /></h2>
	<p class="margin-more-bottom"><s:text name="jpuserprofile.note.current" />:&#32;<em class="important"><s:property value="userProfile.username" /></em></p>
	<s:form>
