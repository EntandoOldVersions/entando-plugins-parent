...
<p><label for="withProfile" class="basic-mint-label label-search"><s:text name="jpuserprofile.note.search.hasProfile"/>:</label>
	<wpsf:select useTabindexAutoIncrement="true" name="withProfile" id="withProfile" 
		list="#{1:getText('label.yes'),0:getText('label.no')}" headerKey="" headerValue="%{getText('label.bothYesAndNo')}" />
</p>
...
<tr>
	...
	<th class="icon"><abbr title="<s:text name="label.state" />">S</abbr></th>
        <th><abbr title="<s:text name="jpuserprofile.label.profile.action.long" />"><s:text name="jpuserprofile.label.profile.action.short" /></abbr></th>
</tr>
