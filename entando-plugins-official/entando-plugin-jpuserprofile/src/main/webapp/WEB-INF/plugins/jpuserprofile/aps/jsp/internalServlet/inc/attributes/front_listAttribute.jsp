...
<s:set name="masterListAttribute" value="#attribute" />
	<s:iterator value="#attribute.getAttributeList(#lang.code)" id="attribute" status="elementStatus">
		...
		<s:set var="attribute_id">jpuserprofile_<s:property value="#attribute.name" />_<s:property value="#elementStatus.index + 1" /></s:set>
...
<p><s:include value="/WEB-INF/plugins/jpuserprofile/aps/jsp/internalServlet/inc/attributes/listAttributes/front_allList_addElementButton.jsp" /></p>