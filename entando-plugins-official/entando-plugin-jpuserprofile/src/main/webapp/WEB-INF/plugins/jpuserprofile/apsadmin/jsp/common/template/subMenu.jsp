...
<div id="fagiano_jpuserprofile" class="menuToggler"><div class="menuToggler-1"><div class="menuToggler-2">
	<ul>
		<li><a href="<s:url namespace="/do/jpuserprofile/Profile" action="edit" />" ><s:text name="jpuserprofile.menu.changeUserProfile" /></a></li>
		<wp:ifauthorized permission="jpuserprofile_profile_view">
		<li><a href="<s:url namespace="/do/jpuserprofile/Search" action="list" />" ><s:text name="jpuserprofile.menu.searchProfiles" /></a></li>
		</wp:ifauthorized>
