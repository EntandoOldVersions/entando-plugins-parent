...
public class ApiUserProfileTypeInterface {
    ...
    public JAXBUserProfileType getProfileType(Properties properties) throws ApiException, Throwable {
    ...
    public BaseApiResponse addProfileType(JAXBUserProfileType jaxbProfileType) throws Throwable {
    ...
    public BaseApiResponse updateProfileType(JAXBUserProfileType jaxbProfileType) throws Throwable {
        BaseApiResponse response = new BaseApiResponse();
        try {
            String typeCode = jaxbProfileType.getTypeCode();
            IApsEntity masterProfileType = this.getUserProfileManager().getEntityPrototype(typeCode);
    ...
    public void deleteProfileType(Properties properties) throws ApiException, Throwable {
        try {
            String typeCode = properties.getProperty("profileTypeCode");
            IApsEntity masterProfileType = this.getUserProfileManager().getEntityPrototype(typeCode);
            if (null == masterProfileType) {
