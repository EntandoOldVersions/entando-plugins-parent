 ...
 * @author E.Santoboni
 */
public class TestFrontCommonAction extends ApsAdminPluginBaseTestCase {
	...
	public void testGoChangePasswordPage() throws Throwable {
    	this.initAction("/do/jpuserprofile/Front/CurrentUser", "editPassword");
	...
	private String executeUpdate(String oldPassword, String password, String passwordConfirm) throws Throwable {
		this.initAction("/do/jpuserprofile/Front/CurrentUser", "changePassword");
