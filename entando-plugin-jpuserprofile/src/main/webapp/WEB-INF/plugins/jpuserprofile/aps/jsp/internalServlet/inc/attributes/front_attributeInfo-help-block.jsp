...
<s:if test="%{#hasValidationRulesVar || (#attribute.textAttribute && (#attribute.minLength != -1 || #attribute.maxLength != -1)) || #attribute.type == 'Date' }">
	<span class="help-block">
		...
		<s:if test="#attribute.minLength != -1">
			&#32;
			<abbr title="<wp:i18n key="jpuserprofile_ENTITY_ATTRIBUTE_MINLENGTH_FULL" />&#32;<s:property value="#attribute.minLength" />">
				<wp:i18n key="jpuserprofile_ENTITY_ATTRIBUTE_MINLENGTH_SHORT" />:&#32;<s:property value="#attribute.minLength" />
			</abbr>
		</s:if>
		<s:if test="#attribute.maxLength != -1">
			&#32;
			<abbr title="<wp:i18n key="jpuserprofile_ENTITY_ATTRIBUTE_MAXLENGTH_FULL" />&#32;<s:property value="#attribute.maxLength" />">
				<wp:i18n key="jpuserprofile_ENTITY_ATTRIBUTE_MAXLENGTH_SHORT" />:&#32;<s:property value="#attribute.maxLength" />
			</abbr>
		</s:if>
	</span>
</s:if>