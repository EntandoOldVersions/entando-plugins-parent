...
<s:iterator value="#attribute.attributes" var="attribute">
	...
	<s:set var="attribute_id">jpuserprofile_<s:property value="%{i18n_parent_attribute_name}" /><s:property value="#attribute.name" />_<s:property value="#elementIndex" /></s:set>
