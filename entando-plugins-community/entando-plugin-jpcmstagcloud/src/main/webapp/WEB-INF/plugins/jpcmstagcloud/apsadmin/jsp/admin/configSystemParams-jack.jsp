...
<fieldset>
	...
	<p class="important"><s:text name="jpcmstagcloud.hookpoint.configSystemParams.categoryRoot" />:</p>
	<s:set name="jpcmstagcloud_paramName" value="'jpcmstagcloud_categoryRoot'" />
        ...
        <wpsf:hidden useTabindexAutoIncrement="true" name="%{#jpcmstagcloud_paramName + externalParamMarker}" value="true"/>
	
	<p class="important"><s:text name="jpcmstagcloud.hookpoint.configSystemParams.delayDays" />:</p>
