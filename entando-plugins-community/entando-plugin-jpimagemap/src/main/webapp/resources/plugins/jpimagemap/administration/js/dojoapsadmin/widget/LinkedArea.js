...
dojo.provide("dojoapsadmin.widget.LinkedArea");
...
}, showLinkedArea:function () {
	this.bringToTop();
}, onLinkedAreaShow:function () {
	var mb = dojo.html.getMarginBox(this.domNode);
	this.resizeTo(mb.width, mb.height);
...
dojo.widget.defineWidget("dojoapsadmin.widget.LinkedArea", [dojo.widget.ContentPane, dojo.widget.FloatingPaneBase], {fillInTemplate:function (args, frag) {
