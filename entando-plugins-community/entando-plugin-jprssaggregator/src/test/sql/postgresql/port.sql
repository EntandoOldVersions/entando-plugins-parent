INSERT INTO sysconfig (version, item, descr, config) VALUES ('test', 'jprssaggregator', 'mapping per la conversione dei feed rss in contenuti', '<?xml version="1.0" encoding="UTF-8"?>
<mappings>
