...
<%-- inclusione dovuta a momentaneo disallineamento tra la versione di japs rilasciata e la versione di questa jsp necessaria al plugin. Potrà venire eliminata al rilascio successivo. --%>
