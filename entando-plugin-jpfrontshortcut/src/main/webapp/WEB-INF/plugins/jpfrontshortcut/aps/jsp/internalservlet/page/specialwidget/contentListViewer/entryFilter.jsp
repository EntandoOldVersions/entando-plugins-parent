...
<%-- INIZIO FILTRO PER ATTRIBUTO TIPO BOOLEANO --%>
	<s:text name="note.filterTypes.BooleanAttribute" /> )</em></p>
	<fieldset>
		<legend><s:text name="label.settings"/></legend>	
		<ul class="nstyled">
			<li>
				<label class="radio" for="booleanValue_true"><input type="radio" name="booleanValue" id="booleanValue_true" value="true" /><s:text name="label.yes" /></label>
			</li>
			<li>
				<label for="booleanValue_false"><input type="radio" name="booleanValue" id="booleanValue_false" value="false" />		<s:text name="label.no" /></label>
			</li>
			<li>
				<label for="booleanValue_none"><input type="radio" name="booleanValue" id="booleanValue_none" checked="checked" value="" /><s:text name="label.all" /></label>
			</li>		
		</ul>
	</fieldset>
<%-- FINE FILTRO PER ATTRIBUTO TIPO BOOLEANO --%>
</s:elseif>
