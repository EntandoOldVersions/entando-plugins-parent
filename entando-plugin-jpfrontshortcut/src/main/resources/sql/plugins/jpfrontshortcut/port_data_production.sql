...
INSERT INTO widgetconfig (pagecode, framepos, showletcode, config, publishedcontent) VALUES ('jpfrontshortcut_test', 1, 'jpfrontshortcut_navigation_menu', '<?xml version="1.0" encoding="UTF-8"?>
<properties>
<property key="navSpec">code(homepage).subtree(2)</property>
</properties>', NULL);
INSERT INTO widgetconfig (pagecode, framepos, showletcode, config, publishedcontent) VALUES ('jpfrontshortcut_test', 5, 'jpfrontshortcut_info', NULL, NULL);
