...
<div id="main">
	<h2><s:text name="title.jpsurvey.survey.results" /></h2>
	
	<dl class="table-display">
		<dt><s:text name="jpsurvey_title" /></dt>
		<dd><s:property value="%{getLabel(survey.titles)}" /></dd>
		<dt><s:text name="jpsurvey_description" /></dt>
		<dd><s:property value="%{getLabel(survey.descriptions)}" /></dd>
		<dt><s:text name="jpsurvey_voters" /></dt>
		<dd><s:property value="%{totalVoters}" /></dd>
	</dl>
	...
	<s:iterator var="question" value="survey.questions" status="questionIndex">
		<div class="subsection-light">
			...
			<p><s:text name="jpsurvey_question"/>&#32;<s:property value="#questionIndex.index + 1"/>. <s:property value="%{getLabel(#question.questions)}" /></p>
			<p><s:text name="jpsurvey_answers" />:</p>
			<ol>	
